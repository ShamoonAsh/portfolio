...
// --- technology logos ---------------------------------------------------
// Injected rather than hand-written into every tag. Applies to the per-project
// tags only; the tools strip is deliberately left as plain text. Anything not
// in the map keeps its label with no icon.
const TECH_ICONS = {
  "C#": "csharp",
  ".NET / MVC": "dotnet",
